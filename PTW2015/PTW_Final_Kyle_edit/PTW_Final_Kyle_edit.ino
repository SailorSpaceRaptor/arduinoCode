...
{
    // select the bit
    r0 = bitRead(button,0);    // use this with arduino 0013 (and newer versions)     
    r1 = bitRead(button,1);    // use this with arduino 0013 (and newer versions)     
    r2 = bitRead(button,2);    // use this with arduino 0013 (and newer versions)    
    digitalWrite(8, r0);
    digitalWrite(9, r1);
    digitalWrite(10, r2);
}
