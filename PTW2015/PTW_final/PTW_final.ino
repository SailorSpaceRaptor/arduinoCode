...
int IRQ_BTNPRESS = 2; //interrupt 0 on pin 2
int btnNum = 0; //start at this for statemachine

pinMode(IRQ_BTNPRESS, INPUT); //BTN PRESS is input
attachInterrupt(IRQ_ BTNPRESS, ISR_BTNPRESS, LOW); //interrupt activated on falling edge
}
...
void ISR_BTNPRESS()
{
  //read MUX to see which which button was pressed
  btnNum = //integer value of mux output
}
