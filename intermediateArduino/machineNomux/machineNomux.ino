...
#define m1 4//define pin for MUX out 1
#define m2 5//define pin for MUX out 2
...
void loop() 
{
  ...
  digitalWrite(m0, LOW);//digitalWrite(muxPin2, bit0)
  digitalWrite(m1, LOW);//digitalWrite(muxPin3, bit1)
  digitalWrite(m2, LOW);//digitalWrite(muxPin4, bit2)
